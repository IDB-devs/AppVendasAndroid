...
class BannerVendedor(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.bind(pos=self.atualizar_rec, size=self.atualizar_rec) #para redimensionar automaticamente
        ...
        link = f'https://appvendashash-b88af-default-rtdb.firebaseio.com/.json?orderBy="id_vendedor"&equalTo="{id_vendedor}"'
        requisicao = requests.get(link)
        requisicao_dic = requisicao.json() #dicionario python
        # print(requisicao_dic) para ajudar a ver raciocinio
        valor = list(requisicao_dic.values())[0] #pegando os valores do dicionario sem a chave
        avatar = valor['avatar'] #pegando o valor dentro da lista pela chave
    ...
    # garante o dimensionamento automatico do background   
